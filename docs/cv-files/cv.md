...
- 15 years of overall experience in the IT and software industry.  
- Proficient in creating clear and concise, user-friendly documentation for developers and end users. Authored comprehensive product documentation for a platform-based product.  
- Proven capability in owning and managing the documentation lifecycle for a start-up environment.  
- Experienced in creating content strategy, tooling, and document infrastructure aligning with the latest industry standards.  
